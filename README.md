...
Soy un jóven con interes por la programación. Con más de 2 años de experiencia en el ambiente, he adquirido habilidades sólidas en diversas tecnologías y frameworks, incluyendo Java, Javascript, PHP, HTML, CSS, SQL, Spring Boot. Mi enfoque es crear proyectos bien estructurados con buenas prácticas.
...
| **IDE's**             | [![IDE's](https://skillicons.dev/icons?i=visualstudio,microsoftvisualstudio)](https://skillicons.dev)                                             |
